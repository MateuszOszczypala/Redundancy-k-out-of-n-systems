...
vehicles = 50; % max number of vehicles in transportation system
lambda = 0.0037; % failure intensity
mi = 0.1317; % renewal intensity
mu = 9.1323; % k
sigma = 7.6943; %f k
...
for s = 1:19
    ...
    for l = 1:19
     ...
     for j = 1:time_simulation % sampling k-out-of-n
           p_k = rand(1,1);
           k = icdf('Normal',p_k, mu1, sigma1); % logistic distribution with parameters mu and sigma
           if k < 0
               k = 0;
           end

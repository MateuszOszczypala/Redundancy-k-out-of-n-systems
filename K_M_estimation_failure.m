...
annotation('textbox', [0.60, 0.25, 0.1, 0.1], 'String', "{\it\lambda} = "+round(lambda,4)+" day^-^1",'EdgeColor','none','FontSize', 9);
fontsize(gca,11,"pixels");
saveas(h, 'Kaplan_Meier_estimation_of_failure_cdf','fig');
%close (h);
